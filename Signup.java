...
public class Signup extends JFrame implements ActionListener{
	...
	comboBox.setBounds(260, 202, 148, 20);
	...
	contentPane.add(lblSecurityQuestion);
        ...
        ImageIcon c1 = new ImageIcon(ClassLoader.getSystemResource("cab\\booking\\system\\New folder\\icons\\signup.png"));
	...
	textField.setBounds(260, 91, 148, 20);
	contentPane.add(textField);
	textField.setColumns(10);

	textField_1 = new JTextField();
	textField_1.setColumns(10);
	textField_1.setBounds(260, 125, 148, 20);
	contentPane.add(textField_1);

        textField_2 = new JTextField();
	textField_2.setColumns(10);
	textField_2.setBounds(260, 159, 148, 20);
	contentPane.add(textField_2);

	textField_3 = new JTextField();
	textField_3.setColumns(10);
	textField_3.setBounds(260, 239, 148, 20);
